...
// DnD uses 5s loader on incorrect, 3s on final incorrect
...
export default function CheckpointSlide({
  ...
  const [activeMarker, setActiveMarker] = useState<"yellow" | "pink" | "eraser">("yellow");
  ...
  return (
    <div className="w-full h-full flex flex-col md:flex-row gap-3 sm:gap-4 md:gap-6 items-stretch min-h-0 relative">
      ...
      >
        {/* Question header bar matching original gray bar */}
        <div className="bg-[#eeeeee] -mx-4 sm:-mx-6 -mt-4 sm:-mt-6 px-4 sm:px-6 py-3 mb-4 rounded-t-xl shadow-[0_-2px_4px_rgba(0,0,0,0.2)] text-center">
          <h3 className="font-bold text-base text-gray-900">{checkpoint.skill}</h3>
        </div>
              ...
              {dndState === "interacting" && (
                <div className="flex gap-3 justify-end items-center">
                  ...
                  <motion.button
                    ...
                    className="px-6 py-2.5 text-white text-sm font-semibold rounded shadow-md disabled:opacity-40 disabled:cursor-not-allowed"
              ...
              <div className={`mt-auto pt-4 border-t border-gray-100 ${highlightToolsDisabled ? "opacity-40 pointer-events-none" : ""}`}>
                ...
                <div className="flex items-center gap-3">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.9 }}
                    className={`w-[39px] h-[39px] rounded border-2 transition-colors ${
                      activeMarker === "yellow"
                        ? "border-gray-800 shadow-[inset_0_0_3px_rgba(0,0,0,0.3)]"
                  ...
                  <motion.button
                    onClick={() => setActiveMarker("eraser")}
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.9 }}
                    className={`w-[39px] h-[39px] rounded border-2 flex items-center justify-center transition-colors ${
                      activeMarker === "eraser"
                        ? "border-gray-800 bg-gray-100 shadow-[inset_0_0_3px_rgba(0,0,0,0.3)]"
                        : "border-gray-200 bg-white hover:border-gray-400"
                    }`}
                    title="Eraser"
                  >
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M20 20H7L3 16c-.8-.8-.8-2 0-2.8L14.4 1.8c.8-.8 2-.8 2.8 0L21 5.6c.8.8.8 2 0 2.8L12 17" />
                    </svg>
                  </motion.button>
                </div>
